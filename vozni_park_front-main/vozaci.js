...
async function getVozaci() {
    ...
    try {
        ...
        let row
        const response = await fetch("http://localhost:4000/vozaci")
...
async function deleteVozaci(vozaciId) {
    ...
    try {
        ...
        const response = await fetch(`http://localhost:4000/vozaci/${vozaciId}`, {
            method: "DELETE"
        })
...
const openUpdateModal = async (idVozaca) => {
    ...
    try {
        ...
        const response = await fetch(`http://localhost:4000/vozaca/${idVozaca}`)
        ...
        document.getElementById("broj_vozacke_dozvole").value = data?.broj_vozacke_dozvole
        document.getElementById("datum_isteka_dozvoleUpdate").value = data?.datum_isteka_dozvole
        document.getElementById("kategorije_vozacke_dozvole").value = data?.kategorije_vozacke_dozvole
